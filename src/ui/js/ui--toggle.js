...
function setToggle(toggleLink, toggleId, toggleCover) {
	...
	const openHeight = () => {
		...
		toggleCover.addEventListener('transitionend', () => isActive() ? toggleCover.style.height = '' : null, { once: true })
		toggleCover.addEventListener('transitionend', () => isActive() ? toggleCover.style.overflow = 'visible' : null, { once: true })
