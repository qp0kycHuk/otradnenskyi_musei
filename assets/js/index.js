...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "getMaskedValue": () => (/* binding */ getMaskedValue),
/* harmony export */   "getUnmaskedValue": () => (/* binding */ getUnmaskedValue),
/* harmony export */   "isComplete": () => (/* binding */ isComplete)
/* harmony export */ });
var phoneRegexp = /(7|8)?(\d{0,3})(\d{0,3})(\d{0,2})(\d{0,2})/;
var phoneCompleteRegexp = /(7|8)\d{10}$/;
function getUnmaskedValue(value) {
  return value.replace(/\D/g, '');
}
function getMaskedValue(value) {
  var numberValue = value.toString().replace(/\D/g, '');

  if (!numberValue) {
    return '';
  }

  var matchValue = numberValue.match(phoneRegexp);
  ...
  var b = matchValue[3];
  var c = matchValue[4];
  var d = matchValue[5]; // +7 (aaa) bbb - cc - dd

  var maskedValue = "+7".concat(a ? " (".concat(a) : '').concat(b ? ") ".concat(b) : '').concat(c ? " - ".concat(c) : '').concat(d ? " - ".concat(d) : '');
  return maskedValue;
}
...
function init(selector) {
  document.addEventListener('input', function (event) {
    ...
    var maskedValue = getMaskedValue(event.target.value);
...
var init = function init() {
  ...
  _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.modal = {};

  _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.modal.open = function (src, options) {
    _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.show([_objectSpread({
      src: src
...
/* harmony import */ var _ui_tab__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ui--tab */ "./src/ui/js/ui--tab.js");
/* harmony import */ var _range_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./range-slider */ "./src/ui/js/range-slider.js");
/* harmony import */ var npm_kit_toggle__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! npm-kit-toggle */ "./node_modules/npm-kit-toggle/index.js");
/* harmony import */ var _ui_parallax__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ui--parallax */ "./src/ui/js/ui--parallax.js");
...
function loadHandler() {
  ...
  _ui_tab__WEBPACK_IMPORTED_MODULE_4__["default"].init();
  npm_kit_toggle__WEBPACK_IMPORTED_MODULE_6__["default"].init();
  _ripple__WEBPACK_IMPORTED_MODULE_8__["default"].init();
  _theme__WEBPACK_IMPORTED_MODULE_9__["default"].init(); // parallax.init()
...
var init = function init() {
  var range = Range('.form-range', {
    onChange: function onChange(options) {
      ...
      toValue = parseInt(toValue); // if (options.target.getAttribute('data-round')) {
...
function clickHandler(event) {
  ...
  var leaveHandler = function leaveHandler() {
    ...
    var remove = function remove() {
      isRemoved = true;
      setTimeout(function () {
        return ripple.parentElement.removeChild(ripple);
      }, 500);
    };
  ...
  document.addEventListener(getSupportedEvents().end, leaveHandler, {
    once: true
  });
  document.addEventListener('dragend', leaveHandler, {
    once: true
  });
  document.addEventListener(getSupportedEvents().move, leaveHandler, {
    once: true
  });
  return false;
}
...
var clickHandler = function clickHandler(event) {
  ...
  var id = event.target.closest('[data-show-pass]').getAttribute('data-show-pass');
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _getCookie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getCookie */ "./src/ui/js/getCookie.js");
...
function saveTheme() {
  var activeThemeJson = JSON.stringify(activeTheme);
...
function initTheme() {
  var activeThemeJson = (0,_getCookie__WEBPACK_IMPORTED_MODULE_0__["default"])('activeThemeJson');
  ...
  try {
    var oldActiveTheme = JSON.parse(activeThemeJson);
...
function parallax() {
  if (!flag) return;
  flag = false;
  var parallaxItems = document.querySelectorAll('[' + attr.cover + ']');
  ...
  var _loop = function _loop(i) {
    ...
    var elem = parallaxItems[i];
    /* eslint-disable */

    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3176718258_20_2_20_19_4", elem)));

    var parent = elem.closest('[' + attr.parent + ']') || elem.parentElement;
    var parentOffset = parent.getBoundingClientRect().top;
    var coof = -parentOffset;
    var speed = elem.getAttribute(attr.speed);
...
function setToggle(toggleLink, toggleId, toggleCover) {
	...
	const openHeight = () => {
		...
		const transition = Math.max(toggleCover.scrollHeight / 2, 100)
		toggleCover.style.height = isNaN(parseInt(height)) ? '0px' : parseInt(height) + 'px';
		toggleCover.style.transition = transition + 'ms ease';
		setTimeout(() => toggleCover.style.height = toggleCover.scrollHeight + 'px', 10);
		setTimeout(() => isActive() ? toggleCover.style.height = '' : null, 10 + transition);
		setTimeout(() => isActive() ? toggleCover.style.overflow = 'visible' : null, 10 + transition);
	}
	const closeHeight = () => {
		const height = toggleCover.getAttribute(attr.coverHeight);
		if (toggleCover.classList.contains('no-transition')) {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ui_js_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ui/js/index */ "./src/ui/js/index.js");
/* harmony import */ var _phonemask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./phonemask */ "./src/phonemask.js");
...
_ui_js_index__WEBPACK_IMPORTED_MODULE_0__["default"].init();
var gsapAnimation = {
  fadeInLeft: {
    from: {
      x: '-50%',
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  div.remove();
  document.body.style.setProperty('--scrollbar-width', scrollWidth + 'px'); // mask

  _phonemask__WEBPACK_IMPORTED_MODULE_1__["default"].init('[type="tel"]'); // init gsap animation

  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.registerPlugin(gsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger);
  var scrollElements = document.querySelectorAll('.gsap-scroll');
  scrollElements.forEach(function (element) {
    var key = element.getAttribute('data-animation');
    var duration = element.getAttribute('data-duration') || 1.00;
    var end = element.getAttribute('data-end') || 'top center';
    var delay = element.getAttribute('data-delay') || 0.100;
    gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.fromTo(element, gsapAnimation[key].from, _objectSpread(_objectSpread({}, gsapAnimation[key].to), {}, {
      // opacity: 1,
      // x: 0,
      // y: 0,
      duration: duration,
  ...
  var animElements = document.querySelectorAll('.gsap');
  ...
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to('[data-parallax]', {
    y: 200,
    scrollTrigger: {
...
function toggleHandler(event) {
  if (event.detail.target.closest('.header-nav__popup')) {
    var nav = event.detail.target.closest('.header-nav');
